  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='w-full'>
            ...
            <textarea onChange={(e) =>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] py-2 px-3 ' type='text' placeholder='Write about product' required/>
        </div>
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            <div>
                ...
                <select onChange={(e) =>setCategory(e.target.value)} className='w-full px-3 py-2'>
                    ...
                    <option value="Hoodies&SweetShirts">Hoodies&SweetShirts</option>
